...
public class TakeInReviewTest extends AbstractUnitTest {
    ...
    void execute_firstGroupReviewer_taskInfo() throws TelegramApiException {
        ...
        Update update = getUpdateWithCallbackQuery("/" + TAKE_IN_REVIEW + "#" + review1.getTask().getId(), REVIEWER_1_CHAT_ID);
    ...
    void execute_firstGroupReviewer_reviewList() throws TelegramApiException {
        Member reviewer = getMember(REVIEWER_1_CHAT_ID, 1, false, false);
        Update update = getUpdateWithCallbackQuery("/" + TAKE_IN_REVIEW, REVIEWER_1_CHAT_ID);
    ...
    void execute_secondGroupReviewer_taskInfo() throws TelegramApiException {
        Member reviewer = getMember(REVIEWER_1_CHAT_ID, 2, false, false);
        Update update = getUpdateWithCallbackQuery("/" + TAKE_IN_REVIEW + "#" + review3.getTask().getId(), REVIEWER_1_CHAT_ID);
    ...
    void execute_secondGroupReviewerAndDesign_reviewList() throws TelegramApiException {
        Member reviewer = getMember(REVIEWER_1_CHAT_ID, 2, true, false);
        Update update = getUpdateWithCallbackQuery("/" + TAKE_IN_REVIEW, REVIEWER_1_CHAT_ID);
